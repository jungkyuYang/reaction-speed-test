...
export const metadata: Metadata = {
  ...
  keywords: "reaction time test, click speed test, reflex test, gaming performance, online test",
  authors: [{ name: "Reaction Speed Test" }],
  openGraph: {
    title: "Reaction Speed Test - Test Your Reflexes Online",
    description: "Test your reaction time and clicking speed. Compare with players worldwide!",
    type: "website",
